...
CHECKS = {
 ...
 "app/ui/board.html": [
   ...
   "logq", "relTime", "editSummary", "setAccepting", "requeue", "notifyO", "editAbout", "phoneOrder", "showReadiness",
 ...
 "app/dispatch.py": ["TRANSITIONS", "_fq", "not on your sheet", "_TTL_CACHE",
                      ...
                      "order_feedback", "kitchen_feedback", "driver_earnings", "launch_readiness"],
